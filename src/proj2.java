...
public class proj2 {
    ...
    public static void main(String args[])
    {
      ...
      /*if both playerMove and computerMove
        ...
        else if (playerMove.equals(proj2.ROCK))
            System.out.println(computerMove.equals(proj2.PAPER) ? "Computer Wins": "Player wins");
            // if playerMove is PAPER
        else if (playerMove.equals(proj2.PAPER))
            System.out.println(computerMove.equals(proj2.SCISSORS) ? "Computer Wins": "Player wins");
            // if playerMove is SCISSORS
        else
            System.out.println(computerMove.equals(proj2.ROCK) ? "Computer Wins": "Player wins");
    }
    ...
    public static String getComputerMove()
    {
        ...
        if (input == 1)
            computermove = proj2.ROCK;
        else if(input == 2)
            computermove = proj2.PAPER;
        else
            computermove = proj2.SCISSORS;
